  ...
  return (
    <div className='w-full flex flex-col-reverse md:flex-row p-4 md:p-20 bg-[#fffff] items-center text-justify overflow-hidden'>
        ...
        whileInView={{ x: [-100, 0], opacity: [0, 1] }}
          transition={{ duration: 2 }} src='./img.jpg'
        ...
        <motion.div
          ...
          className='flex flex-col text-textcolor justify-center p-4 md:pl-28 gap-8'>
            <p>“The “Finland Chamber of Commerce in India” (“FINCHAM India”) was incorporated as a Section 8 Company on February 28, 2018, with the primary purpose of inter alia: promoting and deepening commercial and industrial ties, trade, economic, social and cultural relations between India and Finland.”</p>
            <button type="button"
