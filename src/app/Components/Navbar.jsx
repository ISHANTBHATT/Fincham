...
const Links = [
  {
    name: "Embassy of Finland in India",
    href: "https://finlandabroad.fi/web/ind/frontpage",
  },
  {
    name: "Embassy of India in Finland",
    href: "https://www.indembhelsinki.gov.in/index.php",
  },
  {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex lg:hidden">
          <button
            ...
            className={`-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 ${
              isScrolled ? "text-textcolor" : "text-white"
            }`}
          >
        ...
        <PopoverGroup
          className={`hidden lg:flex gap-x-4 xl:gap-x-12   ${
            isScrolled ? "text-textcolor" : "text-white"
          } `}
        >
          <a
            href="../"
            className="text-sm font-semibold leading-6 hover:text-[#f6aa00]"
          >
            Home
          </a>
