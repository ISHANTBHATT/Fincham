...
function Partner() {
  return (
    <div className='w-full h-full text-white bg-gradient-to-r from-pink-500 to-yellow-500'>
            ...
            <a href='../contact-us' className='w-full lg:w-1/5'>
            <button type="button" className="bg-[#01306b] hover:bg-[#feb902] w-full text-white px-4 py-3  rounded-full hover:shadow-lg transition-all ease-in-out duration-100">
                Let&apos;s Get Started
            </button>
            </a>
